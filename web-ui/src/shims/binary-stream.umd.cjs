...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BinaryStream = factory();
  }
}(typeof self !== 'undefined' ? self : (typeof globalThis !== 'undefined' ? globalThis : {}), function () {

/**
  BinaryStream is an implementation of binary stream API for JavaScript.
  Based on DataStream - https://github.com/kig/DataStream.js

  @param {ArrayBuffer} arrayBuffer ArrayBuffer to read from.
  @param {?Number} byteOffset Offset from arrayBuffer beginning for the BinaryStream.
  */
var BinaryStream = function(arrayBuffer, byteOffset) {
...
/**
  ...
  NOTE: `depUrls` is a static property of BinaryStream (the factory),like the various
        processing functions. It is NOT part of the prototype of instances.
  @type {Object}
  */
BinaryStream.depUrls = {
...
/**
  Virtual byte length of the BinaryStream backing buffer.
  Updated to be max of original buffer size and last written size.
  If dynamicSize is false is set to buffer size.
  @type {number}
  */
BinaryStream.prototype._byteLength = 0;

/**
  Set/get the backing ArrayBuffer of the BinaryStream object.
  The setter updates the DataView to point to the new buffer.
  @type {Object}
  */
Object.defineProperty(BinaryStream.prototype, 'buffer',
  { get: function() {
      this._trimAlloc();
      return this._buffer;
    },
...
/**
  Set/get the byteOffset of the BinaryStream object.
  The setter updates the DataView to point to the new byteOffset.
  @type {number}
  */
Object.defineProperty(BinaryStream.prototype, 'byteOffset',
  { get: function() {
...
/**
  Set/get the backing DataView of the BinaryStream object.
  The setter updates the buffer and byteOffset to point to the DataView values.
  @type {Object}
  */
Object.defineProperty(BinaryStream.prototype, 'dataView',
  { get: function() {
...
/**
  Internal function to trim the BinaryStream buffer when required.
  ...
  @return {null}
  */
BinaryStream.prototype._trimAlloc = function() {
...
/**
  Returns true if the BinaryStream seek pointer is at the end of buffer and
  there's no more data to read.

  @return {boolean} True if the seek pointer is at the end of the buffer.
  */
BinaryStream.prototype.isEof = function() {
  return this.pos >= this.size && this.bitsLeft === 0;
};

/**
  Sets the BinaryStream read/write position to given position.
  Clamps between 0 and BinaryStream length.

  @param {number} pos Position to seek to.
  @return {null}
  */
BinaryStream.prototype.seek = function(pos) {
  var npos = Math.max(0, Math.min(this.size, pos));
  this.pos = (isNaN(npos) || !isFinite(npos)) ? 0 : npos;
};

/**
  Returns the byte length of the BinaryStream object.
  @type {number}
  */
Object.defineProperty(BinaryStream.prototype, 'size',
  { get: function() {
 ...
 */
BinaryStream.prototype.readS1 = function() {
...
/**
  ...
  @return {number} The read number.
 */
BinaryStream.prototype.readS2be = function() {
...
/**
  ...
  @return {number} The read number.
 */
BinaryStream.prototype.readS4be = function() {
...
/**
  ...
  @return {number} The read number.
 */
BinaryStream.prototype.readS8be = function() {
...
/**
  ...
  @return {number} The read number.
 */
BinaryStream.prototype.readS2le = function() {
  this.ensureBytesLeft(2);
...
/**
  ...
  @return {number} The read number.
 */
BinaryStream.prototype.readS4le = function() {
  this.ensureBytesLeft(4);
...
/**
  ...
  @return {number} The read number.
 */
BinaryStream.prototype.readS8le = function() {
  this.ensureBytesLeft(8);
...
/**
  ...
  @return {number} The read number.
 */
BinaryStream.prototype.readU1 = function() {
  this.ensureBytesLeft(1);
...
/**
  ...
  @return {number} The read number.
 */
BinaryStream.prototype.readU2be = function() {
  this.ensureBytesLeft(2);
...
/**
  ...
  @return {number} The read number.
 */
BinaryStream.prototype.readU4be = function() {
  this.ensureBytesLeft(4);
...
/**
  ...
  @return {number} The read number.
 */
BinaryStream.prototype.readU8be = function() {
  this.ensureBytesLeft(8);
  var v1 = this.readU4be();
  var v2 = this.readU4be();
  return 0x100000000 * v1 + v2;
...
/**
  ...
  @return {number} The read number.
 */
BinaryStream.prototype.readU2le = function() {
  this.ensureBytesLeft(2);
...
/**
  ...
  @return {number} The read number.
 */
BinaryStream.prototype.readU4le = function() {
  this.ensureBytesLeft(4);
...
/**
  ...
  @return {number} The read number.
 */
BinaryStream.prototype.readU8le = function() {
  this.ensureBytesLeft(8);
  var v1 = this.readU4le();
  var v2 = this.readU4le();
  return 0x100000000 * v2 + v1;
...
BinaryStream.prototype.readF4be = function() {
  this.ensureBytesLeft(4);
...
BinaryStream.prototype.readF8be = function() {
  this.ensureBytesLeft(8);
...
BinaryStream.prototype.readF4le = function() {
  this.ensureBytesLeft(4);
...
BinaryStream.prototype.readF8le = function() {
  this.ensureBytesLeft(8);
...
BinaryStream.prototype.alignToByte = function() {
  this.bitsLeft = 0;
  this.bits = 0;
};
  ...
  |01101xxx|xxxxxxxx|xx......|
        \             /\     \
         \__ n = 13 _/  \     \
                       new bitsLeft = 6
 */
BinaryStream.prototype.readBitsIntBe = function(n) {
...
/**
 * Unused since binary stream Compiler v0.9+ - compatibility with older versions
 *
 * @deprecated use {@link readBitsIntBe} instead
 */
BinaryStream.prototype.readBitsInt = BinaryStream.prototype.readBitsIntBe;
...
/*
 ...
 bitsLeft = 3  ______       __
    ...
    |01101100|..xxxxx1|........|
                ...
                n = 5
 */
BinaryStream.prototype.readBitsIntLe = function(n) {
  // JS only supports bit operations on 32 bits
  if (n > 32) {
...
/**
  Native endianness. Either BinaryStream.BIG_ENDIAN or BinaryStream.LITTLE_ENDIAN
  depending on the platform endianness.

  @type {boolean}
 */
BinaryStream.endianness = new Int8Array(new Int16Array([1]).buffer)[0] > 0;

// ========================================================================
// Byte arrays
// ========================================================================

BinaryStream.prototype.readBytes = function(len) {
  return this.mapUint8Array(len);
};

BinaryStream.prototype.readBytesFull = function() {
  return this.mapUint8Array(this.size - this.pos);
};

BinaryStream.prototype.readBytesTerm = function(terminator, include, consume, eosError) {
...
// Unused since binary stream Compiler v0.9+ - compatibility with older versions
BinaryStream.prototype.ensureFixedContents = function(expected) {
...
BinaryStream.bytesStripRight = function(data, padByte) {
...
BinaryStream.bytesTerminate = function(data, term, include) {
  var newLen = 0;
...
BinaryStream.bytesToStr = function(arr, encoding) {
  if (encoding == null || encoding.toLowerCase() === "ascii") {
    return BinaryStream.createStringFromArray(arr);
  } else {
    if (typeof TextDecoder === 'function') {
      ...
      switch (encoding.toLowerCase()) {
        ...
        default:
          ...
          if (typeof BinaryStream.iconvlite === 'undefined')
            BinaryStream.iconvlite = require('iconv-lite');

          return BinaryStream.iconvlite.decode(arr, encoding);
      }
    }
  }
};
...
BinaryStream.processXorOne = function(data, key) {
...
BinaryStream.processXorMany = function(data, key) {
  var dl = data.length;
...
BinaryStream.processRotateLeft = function(data, amount, groupSize) {
  if (groupSize !== 1)
...
BinaryStream.processZlib = function(buf) {
  if (typeof require !== 'undefined')  {
    // require is available - we're running under node
    if (typeof BinaryStream.zlib === 'undefined')
      BinaryStream.zlib = require('zlib');
    // use node's zlib module API
    var r = BinaryStream.zlib.inflateSync(
    ...
    // user should have configured BinaryStream.depUrls.zlib, if not
    // we'll throw.
    if (typeof BinaryStream.zlib === 'undefined'
      && typeof BinaryStream.depUrls.zlib !== 'undefined') {
      importScripts(BinaryStream.depUrls.zlib);
      BinaryStream.zlib = pako;
    }
    // use pako API
    r = BinaryStream.zlib.inflate(buf);
    return r;
  }
};
...
BinaryStream.arrayMin = function(arr) {
  var min = arr[0];
  var x;
...
BinaryStream.arrayMax = function(arr) {
  var max = arr[0];
  var x;
  for (var i = 1, n = arr.length; i < n; ++i) {
    x = arr[i];
...
BinaryStream.byteArrayCompare = function(a, b) {
  if (a === b)
    return 0;
  var al = a.length;
  var bl = b.length;
...
var EOFError = BinaryStream.EOFError = function(bytesReq, bytesAvail) {
  this.name = "EOFError";
...
// Unused since binary stream Compiler v0.9+ - compatibility with older versions
var UnexpectedDataError = BinaryStream.UnexpectedDataError = function(expected, actual) {
...
var UndecidedEndiannessError = BinaryStream.UndecidedEndiannessError = function() {
...
var ValidationNotEqualError = BinaryStream.ValidationNotEqualError = function(expected, actual) {
...
var ValidationLessThanError = BinaryStream.ValidationLessThanError = function(min, actual) {
...
var ValidationGreaterThanError = BinaryStream.ValidationGreaterThanError = function(max, actual) {
...
var ValidationNotAnyOfError = BinaryStream.ValidationNotAnyOfError = function(actual, io, srcPath) {
...
var ValidationExprError = BinaryStream.ValidationExprError = function(actual, io, srcPath) {
...
/**
  ...
  */
BinaryStream.prototype.ensureBytesLeft = function(length) {
...
/**
  Maps a Uint8Array into the BinaryStream buffer.

  Nice for quickly reading in data.

  @param {number} length Number of elements to map.
  @return {Object} Uint8Array to the BinaryStream backing buffer.
  */
BinaryStream.prototype.mapUint8Array = function(length) {
  length |= 0;
...
**/
BinaryStream.createStringFromArray = function(array) {
