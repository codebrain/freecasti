...
_Generated 2026-07-20. Source folder: `sysex/system/dry gain/`._
...
| `nibble_hilo` | Offset 10 | Offset 11 | Label | Source |
| --- | --- | --- | --- | --- |
...
| Label | Offset 10 | Offset 11 | `nibble_hilo` | Checksum 72-75 | Source |
| --- | --- | --- | --- | --- | --- |
| off | `00` | `00` | 0 | `0A` `09` `00` `06` | dump |
| -60 dB | `00` | `01` | 1 | `06` `09` `0F` `0B` | dump |
| -59.5 dB | `00` | `02` | 2 | `06` `08` `0F` `0F` | dump |
| -59 dB | `00` | `03` | 3 | `0A` `08` `00` `02` | dump |
| -45.5 dB | `01` | `0E` | 30 | `0E` `0D` `0E` `0E` | dump |
| -30.5 dB | `03` | `0C` | 60 | `06` `0E` `01` `06` | dump |
| -1 dB | `07` | `07` | 119 | `02` `0C` `0F` `01` | dump |
| -0.5 dB | `07` | `08` | 120 | `02` `09` `0E` `05` | dump |
| full | `07` | `09` | 121 | `0E` `09` `01` `08` | dump |

## Interpretation

- **Primary field:** offsets **10-11**, encoding `nibble_hilo` (encoded * 0.5 + (-60.5)).
