...
_Generated 2026-07-22. Comparing decoded `sysex/prog/presets/` dumps to [Bricasti's published preset sheet](https://www.bricasti.com/images/preset_sheet.pdf) (parsed data: `docs/reference/preset_sheet.json`)._
