...
_Generated 2026-07-21. Source folder: `sysex/prog/parameters/early rolloff/`._
...
| `nibble_hilo` | Offset 126 | Offset 127 | Label | Source |
| --- | --- | --- | --- | --- |
...
| Label | Offset 126 | Offset 127 | `nibble_hilo` | Display lo 147 | Offset 92 | Checksum 152-155 | Source |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 80 Hz | `00` | `00` | 0 | `01` | `02` | `01` `05` `03` `00` | dump |
| 120 Hz | `00` | `01` | 1 | `02` | `00` | `09` `04` `02` `02` | dump |
| 280 Hz | `00` | `05` | 5 | `04` | `02` | `0C` `09` `0F` `0D` | dump |
| 480 Hz | `00` | `09` | 9 | `05` | `00` | `01` `0E` `03` `0D` | dump |
| 13600 Hz | `03` | `00` | 48 | `07` | `00` | `02` `0D` `0B` `01` | dump |
| 22000 Hz | `04` | `05` | 69 | `08` | `00` | `08` `0F` `00` `0A` | dump |
| full | `04` | `06` | 70 | `09` | `00` | `00` `04` `0C` `08` | dump |
...
- **Catalog notes:** Non-linear Hz table @ 126-127. Filter order (dB/octave) analysis: [rolloff-slopes.md](../../../docs/rolloff-slopes.md).
...
- **Never captured on the wire (64):** encoded 2–4, 6–8, 10–47, 49–68 — see the [encoding map](#encoding-map) above for each label.
- **Documented gaps (no row at all):** none between documented min/max.
- **Wire nibbles never observed (`0`–`F`):** offset 126 (high): `5` `6` `7` `8` `9` `A` `B` `C` `D` `E` `F`; offset 127 (low): none
