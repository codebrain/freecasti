...
_Generated 2026-07-20. Source folder: `sysex/prog/parameters/hf rt crossover/`._
...
| `nibble_hilo` | Offset 116 | Offset 117 | Label | Source |
| --- | --- | --- | --- | --- |
...
| Label | Offset 116 | Offset 117 | `nibble_hilo` | Display 146–147 | display `nibble_hilo` | Checksum 152-155 | Source |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 200 Hz | `00` | `00` | 0 | `06 08` | 104 | `0C` `0C` `0A` `03` | dump |
| 240 Hz | `00` | `01` | 1 | `06 0A` | 106 | `0C` `0C` `0F` `06` | dump |
| 480 Hz | `00` | `06` | 6 | `06 0B` | 107 | `0C` `0C` `00` `09` | dump |
| 1200 Hz | `00` | `0C` | 12 | `06 0C` | 108 | `00` `0D` `08` `0E` | dump |
| 3600 Hz | `01` | `04` | 20 | `06 0E` | 110 | `0D` `01` `05` `0F` | dump |
| 6400 Hz | `01` | `08` | 24 | `06 0F` | 111 | `01` `00` `0B` `0E` | dump |
| 9600 Hz | `01` | `0C` | 28 | `07 02` | 114 | `0C` `00` `02` `07` | dump |
| 11200 Hz | `01` | `0E` | 30 | `07 03` | 115 | `0C` `00` `04` `01` | dump |
| 13600 Hz | `02` | `01` | 33 | `07 04` | 116 | `02` `07` `01` `0F` | dump |
| 16000 Hz | `02` | `04` | 36 | `07 05` | 117 | `0E` `07` `0B` `0B` | dump |
