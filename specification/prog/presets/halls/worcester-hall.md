...
_Generated 2026-07-18. Bank: [Halls](README.md) (index **0**). Source: `sysex/prog/presets/Halls.Worcester Hall.syx`._
...
| Bank | Halls (index 0) |
| Program slot | 21 |
| Name field | `Worcester Hall` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Halls.Worcester Hall.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 2.25 s | 41 | 2.25 | match |
| [size](../../parameters/size.md) | 8 | 8 | 8 | match |
...
| [lf rt multiply](../../parameters/lf-rt-multiply.md) | 1.4 | 24 | 1.40 | match |
| [lf rt crossover](../../parameters/lf-rt-crossover.md) | 360 Hz | 7 | 340 | match |
| [vlf cut](../../parameters/vlf-cut.md) | -11 dB | 9 | -11 | match |
