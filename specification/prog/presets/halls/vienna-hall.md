...
_Generated 2026-07-18. Bank: [Halls](README.md) (index **0**). Source: `sysex/prog/presets/Halls.Vienna Hall.syx`._
...
| Bank | Halls (index 0) |
| Program slot | 20 |
| Name field | `Vienna Hall` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Halls.Vienna Hall.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 2.3 s | 42 | 2.30 | match |
| [size](../../parameters/size.md) | 7 | 7 | 7 | match |
| [predelay](../../parameters/predelay.md) | 0 ms | 0 | 0 | match |
| [diffusion](../../parameters/diffusion.md) | 8 | 8 | 8 | match |
...
| [early select](../../parameters/early-select.md) | 16 | 16 | 16 | match |
