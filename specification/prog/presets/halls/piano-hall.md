...
_Generated 2026-07-18. Bank: [Halls](README.md) (index **0**). Source: `sysex/prog/presets/Halls.Piano Hall.syx`._
...
| Bank | Halls (index 0) |
| Program slot | 31 |
| Name field | `Piano Hall` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Halls.Piano Hall.syx` |
...
| [early select](../../parameters/early-select.md) | 16 | 16 | — | no sheet row |
