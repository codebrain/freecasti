...
_Generated 2026-07-18. Bank: [Halls](README.md) (index **0**). Source: `sysex/prog/presets/Halls.The ArchDuke.syx`._
...
| Bank | Halls (index 0) |
| Program slot | 22 |
| Name field | `The ArchDuke` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Halls.The ArchDuke.syx` |
...
| [lf rt multiply](../../parameters/lf-rt-multiply.md) | 1 | 16 | 1 | match |
