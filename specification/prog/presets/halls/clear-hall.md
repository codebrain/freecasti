...
_Generated 2026-07-18. Bank: [Halls](README.md) (index **0**). Source: `sysex/prog/presets/Halls.Clear Hall.syx`._
...
| Bank | Halls (index 0) |
| Program slot | 13 |
| Name field | `Clear Hall` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Halls.Clear Hall.syx` |
...
| [vlf cut](../../parameters/vlf-cut.md) | -4 dB | 16 | -4 | match |
