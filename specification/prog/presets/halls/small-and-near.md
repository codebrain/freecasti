...
_Generated 2026-07-18. Bank: [Halls](README.md) (index **0**). Source: `sysex/prog/presets/Halls.Small & Near.syx`._
...
| Bank | Halls (index 0) |
| Program slot | 5 |
| Name field | `Small & Near` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Halls.Small & Near.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 1.4 s | 24 | 1.40 | match |
| [size](../../parameters/size.md) | 6 | 6 | 6 | match |
...
| [vlf cut](../../parameters/vlf-cut.md) | -7 dB | 13 | -7 | match |
