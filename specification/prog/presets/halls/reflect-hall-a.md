...
_Generated 2026-07-18. Bank: [Halls](README.md) (index **0**). Source: `sysex/prog/presets/Halls.Reflect Hall A.syx`._
...
| Bank | Halls (index 0) |
| Program slot | 29 |
| Name field | `Reflect Hall A` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Halls.Reflect Hall A.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 2.3 s | 42 | — | no sheet row |
...
| [hf rt multiply](../../parameters/hf-rt-multiply.md) | 0.65 | 9 | — | no sheet row |
...
| [lf rt crossover](../../parameters/lf-rt-crossover.md) | 2400 Hz | 20 | — | no sheet row |
...
| [delay time](../../parameters/delay-time.md) | 444 ms | 43 | — | not on sheet |
