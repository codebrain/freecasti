...
| Bank | Halls (index 0) |
| Program slot | 16 |
| Name field | `Berliner Hall` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Halls.Berliner Hall.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 2.5 s | 46 | 2.50 | match |
...
| [early rolloff](../../parameters/early-rolloff.md) | 18000 Hz | 59 | 18000 | match |
| [early select](../../parameters/early-select.md) | 10 | 10 | 10 | match |
