...
_Generated 2026-07-18. Bank: [Halls](README.md) (index **0**). Source: `sysex/prog/presets/Halls.Saint Sylvain.syx`._
...
| Bank | Halls (index 0) |
| Program slot | 24 |
| Name field | `Saint Sylvain` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Halls.Saint Sylvain.syx` |
...
| [hf rt crossover](../../bytes/hf-rt-crossover.md) | 800 Hz | 10 | — | no sheet row |
| [lf rt multiply](../../bytes/lf-rt-multiply.md) | 2.5 | 41 | — | no sheet row |
...
| [early rolloff](../../bytes/early-rolloff.md) | 15600 Hz | 53 | — | no sheet row |
