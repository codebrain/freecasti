...
_Generated 2026-07-18. Bank: [Halls](README.md) (index **0**). Source: `sysex/prog/presets/Halls.Sandors Hall.syx`._
...
| Bank | Halls (index 0) |
| Program slot | 11 |
| Name field | `Sandors Hall` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Halls.Sandors Hall.syx` |
