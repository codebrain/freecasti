...
_Generated 2026-07-19. Bank: [Halls](README.md) (index **0**). Source: `sysex/prog/presets/Halls.Mechanics Hall.syx`._
...
| Bank | Halls (index 0) |
| Program slot | 25 |
| Name field | `Mechanics Hall` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Halls.Mechanics Hall.syx` |
...
| [delay time](../../bytes/delay-time.md) | 428 ms | 41 | — | not on sheet |
