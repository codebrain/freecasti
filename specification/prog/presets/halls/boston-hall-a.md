...
_Generated 2026-07-18. Bank: [Halls](README.md) (index **0**). Source: `sysex/prog/presets/Halls.Boston Hall A.syx`._
...
| Bank | Halls (index 0) |
| Program slot | 17 |
| Name field | `Boston Hall A` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Halls.Boston Hall A.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 2.1 s | 38 | 2.10 | match |
| [size](../../parameters/size.md) | 10 | 10 | 10 | match |
| [predelay](../../parameters/predelay.md) | 0 ms | 0 | 0 | match |
| [diffusion](../../parameters/diffusion.md) | 6 | 6 | 6 | match |
| [density](../../parameters/density.md) | 4 | 4 | 4 | match |
| [modulation](../../parameters/modulation.md) | off | 0 | off | match |
| [rolloff](../../parameters/rolloff.md) | 6000 Hz | 29 | 6000 | match |
| [hf rt multiply](../../parameters/hf-rt-multiply.md) | 0.7 | 10 | 0.70 | match |
...
| [vlf cut](../../parameters/vlf-cut.md) | -2 dB | 18 | -2 | match |
| [early to reverb mix](../../parameters/early-to-reverb-mix.md) | 18/20 | 18 | 18/20 | match |
| [early rolloff](../../parameters/early-rolloff.md) | 15600 Hz | 53 | 15600 | match |
