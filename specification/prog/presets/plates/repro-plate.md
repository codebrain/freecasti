...
_Generated 2026-07-19. Bank: [Plates](README.md) (index **1**). Source: `sysex/prog/presets/Plates.Repro Plate.syx`._
...
| Bank | Plates (index 1) |
| Program slot | 23 |
| Name field | `Repro Plate` (matches filename) |
| Name region 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Plates.Repro Plate.syx` |
