...
_Generated 2026-07-18. Bank: [Plates](README.md) (index **1**). Source: `sysex/prog/presets/Plates.Dense Plate.syx`._
...
| Bank | Plates (index 1) |
| Program slot | 9 |
| Name field | `Dense Plate` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Plates.Dense Plate.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 1.7 s | 30 | 1.70 | match |
...
| [density](../../parameters/density.md) | 10 | 10 | Hi | match |
