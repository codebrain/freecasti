...
_Generated 2026-07-18. Bank: [Plates](README.md) (index **1**). Source: `sysex/prog/presets/Plates.Sun Plate A.syx`._
...
| Bank | Plates (index 1) |
| Program slot | 19 |
| Name field | `Sun Plate A` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Plates.Sun Plate A.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 2.55 s | 47 | — | no sheet row |
...
| [early rolloff](../../parameters/early-rolloff.md) | full | 70 | — | no sheet row |
