...
_Generated 2026-07-19. Bank: [Plates](README.md) (index **1**). Source: `sysex/prog/presets/Plates.Sun Plate B.syx`._
...
| Bank | Plates (index 1) |
| Program slot | 20 |
| Name field | `Sun Plate B` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Plates.Sun Plate B.syx` |
...
| [rolloff](../../bytes/rolloff.md) | 10400 Hz | 40 | — | no sheet row |
