...
_Generated 2026-07-19. Bank: [Plates](README.md) (index **1**). Source: `sysex/prog/presets/Plates.CD Plate A.syx`._
...
| Bank | Plates (index 1) |
| Program slot | 13 |
| Name field | `CD Plate A` (matches filename) |
| Name region 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Plates.CD Plate A.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../bytes/reverb-time.md) | 1.7 s | 30 | 1.70 | match |
...
| [modulation](../../bytes/modulation.md) | high | 11 | h | match |
...
| [early select](../../bytes/early-select.md) | 0 | 0 | 0 | match |
