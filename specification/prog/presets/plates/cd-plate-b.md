...
_Generated 2026-07-18. Bank: [Plates](README.md) (index **1**). Source: `sysex/prog/presets/Plates.CD Plate B.syx`._
...
| Bank | Plates (index 1) |
| Program slot | 14 |
| Name field | `CD Plate B` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Plates.CD Plate B.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 1.6 s | 28 | 1.60 | match |
...
| [density](../../parameters/density.md) | 10 | 10 | high | match |
| [modulation](../../parameters/modulation.md) | 5 | 6 | 5 | match |
...
| [lf rt crossover](../../parameters/lf-rt-crossover.md) | 400 Hz | 8 | 400 | match |
| [vlf cut](../../parameters/vlf-cut.md) | -6 dB | 14 | -6 | match |
| [early to reverb mix](../../parameters/early-to-reverb-mix.md) | 20/20 | 20 | 20/20 | match |
| [early rolloff](../../parameters/early-rolloff.md) | 9600 Hz | 38 | 9600 | match |
| [early select](../../parameters/early-select.md) | 2 | 2 | 2 | match |
