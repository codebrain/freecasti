...
_Generated 2026-07-18. Bank: [Plates](README.md) (index **1**). Source: `sysex/prog/presets/Plates.Snare Plate A.syx`._
...
| Bank | Plates (index 1) |
| Program slot | 3 |
| Name field | `Snare Plate A` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Plates.Snare Plate A.syx` |
