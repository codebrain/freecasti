...
_Generated 2026-07-18. Bank: [Plates](README.md) (index **1**). Source: `sysex/prog/presets/Plates.Gold Plate.syx`._
...
| Bank | Plates (index 1) |
| Program slot | 8 |
| Name field | `Gold Plate` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Plates.Gold Plate.syx` |
