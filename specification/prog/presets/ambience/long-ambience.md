...
_Generated 2026-07-18. Bank: [Ambience](README.md) (index **4**). Source: `sysex/prog/presets/Ambience.Long Ambience.syx`._
...
| Program slot | 10 |
| Name field | `Long Ambience` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Ambience.Long Ambience.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 1.15 s | 19 | 1.15 | match |
| [size](../../parameters/size.md) | 25 | 25 | 25 | match |
...
| [hf rt crossover](../../parameters/hf-rt-crossover.md) | 3600 Hz | 20 | 3600 | match |
...
| [early to reverb mix](../../parameters/early-to-reverb-mix.md) | 20/10 | 30 | 20/10 | match |
