...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 0.45 s | 5 | — | no sheet row |
...
| [early to reverb mix](../../parameters/early-to-reverb-mix.md) | 20/13 | 27 | — | no sheet row |
| [early rolloff](../../parameters/early-rolloff.md) | 10400 Hz | 40 | — | no sheet row |
| [early select](../../parameters/early-select.md) | 1 | 1 | — | no sheet row |
