...
_Generated 2026-07-18. Bank: [Halls 2](README.md) (index **6**). Source: `sysex/prog/presets/Halls 2.Small & Stage.syx`._
...
| Program slot | 5 |
| Name field | `Small & Stage` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Halls 2.Small & Stage.syx` |
...
| [size](../../parameters/size.md) | 11 | 11 | — | no sheet row |
...
| [early to reverb mix](../../parameters/early-to-reverb-mix.md) | 12/20 | 12 | — | no sheet row |
| [early rolloff](../../parameters/early-rolloff.md) | 6800 Hz | 31 | — | no sheet row |
| [early select](../../parameters/early-select.md) | 23 | 23 | — | no sheet row |
