...
_Generated 2026-07-22. Bank: [Halls 2](README.md) (index **6**). Source: `sysex/prog/presets/Halls 2.Large Hall.syx`._
...
| Dump file | `Halls 2.Large Hall.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../bytes/reverb-time.md) | 2.35 s | 43 | — | no sheet row |
