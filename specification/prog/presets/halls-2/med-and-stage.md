...
_Generated 2026-07-18. Bank: [Halls 2](README.md) (index **6**). Source: `sysex/prog/presets/Halls 2.Med & Stage.syx`._
...
| Program slot | 3 |
| Name field | `Med & Stage` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Halls 2.Med & Stage.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 1.75 s | 31 | — | no sheet row |
...
| [vlf cut](../../parameters/vlf-cut.md) | -8 dB | 12 | — | no sheet row |
| [early to reverb mix](../../parameters/early-to-reverb-mix.md) | 14/20 | 14 | — | no sheet row |
