...
_Generated 2026-07-18. Bank: [Halls 2](README.md) (index **6**). Source: `sysex/prog/presets/Halls 2.Jazz Hall.syx`._
...
| Program slot | 8 |
| Name field | `Jazz Hall` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Halls 2.Jazz Hall.syx` |
...
| [rolloff](../../parameters/rolloff.md) | 8800 Hz | 36 | — | no sheet row |
...
| [early to reverb mix](../../parameters/early-to-reverb-mix.md) | 8/20 | 8 | — | no sheet row |
