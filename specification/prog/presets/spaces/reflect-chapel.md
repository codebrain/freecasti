...
_Generated 2026-07-19. Bank: [Spaces](README.md) (index **5**). Source: `sysex/prog/presets/Spaces.Reflect Chapel.syx`._
...
| Bank | Spaces (index 5) |
| Program slot | 17 |
| Name field | `Reflect Chapel` (matches filename) |
| Name region 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Spaces.Reflect Chapel.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../bytes/reverb-time.md) | 3.8 s | 64 | — | no sheet row |
