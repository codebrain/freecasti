...
_Generated 2026-07-18. Bank: [Spaces](README.md) (index **5**). Source: `sysex/prog/presets/Spaces.Reflect Church.syx`._
...
| Bank | Spaces (index 5) |
| Program slot | 18 |
| Name field | `Reflect Church` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Spaces.Reflect Church.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 4 s | 66 | — | no sheet row |
...
| [early to reverb mix](../../parameters/early-to-reverb-mix.md) | 15/20 | 15 | — | no sheet row |
| [early rolloff](../../parameters/early-rolloff.md) | 14000 Hz | 49 | — | no sheet row |
...
| [delay modulation](../../parameters/delay-modulation.md) | 6 | 7 | — | not on sheet |
