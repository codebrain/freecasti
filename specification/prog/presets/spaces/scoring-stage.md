...
_Generated 2026-07-18. Bank: [Spaces](README.md) (index **5**). Source: `sysex/prog/presets/Spaces.Scoring Stage.syx`._
...
| Bank | Spaces (index 5) |
| Program slot | 5 |
| Name field | `Scoring Stage` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Spaces.Scoring Stage.syx` |
...
| [size](../../parameters/size.md) | 18 | 18 | 18 | match |
