...
_Generated 2026-07-19. Bank: [Spaces](README.md) (index **5**). Source: `sysex/prog/presets/Spaces.Cavern.syx`._
...
| Bank | Spaces (index 5) |
| Program slot | 13 |
| Name field | `Cavern` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Spaces.Cavern.syx` |
...
| [hf rt crossover](../../bytes/hf-rt-crossover.md) | 1400 Hz | 13 | — | no sheet row |
