...
_Generated 2026-07-18. Bank: [Spaces](README.md) (index **5**). Source: `sysex/prog/presets/Spaces.Europa.syx`._
...
| Bank | Spaces (index 5) |
| Program slot | 15 |
| Name field | `Europa` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Spaces.Europa.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 25 s | 131 | — | no sheet row |
...
| [modulation](../../parameters/modulation.md) | high | 11 | — | no sheet row |
...
| [lf rt multiply](../../parameters/lf-rt-multiply.md) | 2.2 | 38 | — | no sheet row |
| [lf rt crossover](../../parameters/lf-rt-crossover.md) | 80 Hz | 0 | — | no sheet row |
...
| [early rolloff](../../parameters/early-rolloff.md) | 120 Hz | 1 | — | no sheet row |
