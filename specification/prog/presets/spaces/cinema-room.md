...
_Generated 2026-07-19. Bank: [Spaces](README.md) (index **5**). Source: `sysex/prog/presets/Spaces.Cinema Room.syx`._
...
| Bank | Spaces (index 5) |
| Program slot | 4 |
| Name field | `Cinema Room` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Spaces.Cinema Room.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../bytes/reverb-time.md) | 0.45 s | 5 | 0.45 | match |
...
| [vlf cut](../../bytes/vlf-cut.md) | -4 dB | 16 | -4 | match |
