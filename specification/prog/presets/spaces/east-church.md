...
_Generated 2026-07-19. Bank: [Spaces](README.md) (index **5**). Source: `sysex/prog/presets/Spaces.East Church.syx`._
...
| Bank | Spaces (index 5) |
| Program slot | 1 |
| Name field | `East Church` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Spaces.East Church.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../bytes/reverb-time.md) | 3.3 s | 59 | 3.30 | match |
...
| [lf rt multiply](../../bytes/lf-rt-multiply.md) | 0.5 | 6 | 0.50 | match |
