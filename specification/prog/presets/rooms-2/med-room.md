...
_Generated 2026-07-18. Bank: [Rooms 2](README.md) (index **8**). Source: `sysex/prog/presets/Rooms 2.Med Room.syx`._
...
| Program slot | 2 |
| Name field | `Med Room` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Rooms 2.Med Room.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 0.55 s | 7 | — | no sheet row |
...
| [lf rt multiply](../../parameters/lf-rt-multiply.md) | 1.2 | 20 | — | no sheet row |
...
| [early rolloff](../../parameters/early-rolloff.md) | 5600 Hz | 28 | — | no sheet row |
