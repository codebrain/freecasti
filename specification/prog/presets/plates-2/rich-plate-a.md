...
_Generated 2026-07-19. Bank: [Plates 2](README.md) (index **7**). Source: `sysex/prog/presets/Plates 2.Rich Plate A.syx`._
...
| Program slot | 4 |
| Name field | `Rich Plate A` (matches filename) |
| Name region 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Plates 2.Rich Plate A.syx` |
...
| [hf rt crossover](../../bytes/hf-rt-crossover.md) | 7200 Hz | 25 | — | no sheet row |
...
| [early rolloff](../../bytes/early-rolloff.md) | 8400 Hz | 35 | — | no sheet row |
