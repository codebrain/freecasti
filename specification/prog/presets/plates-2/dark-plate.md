...
_Generated 2026-07-18. Bank: [Plates 2](README.md) (index **7**). Source: `sysex/prog/presets/Plates 2.Dark Plate.syx`._
...
| Program slot | 3 |
| Name field | `Dark Plate` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Plates 2.Dark Plate.syx` |
