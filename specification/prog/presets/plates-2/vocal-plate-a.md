...
_Generated 2026-07-18. Bank: [Plates 2](README.md) (index **7**). Source: `sysex/prog/presets/Plates 2.Vocal Plate A.syx`._
...
| Program slot | 7 |
| Name field | `Vocal Plate A` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Plates 2.Vocal Plate A.syx` |
...
| [predelay](../../parameters/predelay.md) | 30 ms | 15 | — | no sheet row |
