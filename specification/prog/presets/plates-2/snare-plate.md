...
_Generated 2026-07-18. Bank: [Plates 2](README.md) (index **7**). Source: `sysex/prog/presets/Plates 2.Snare Plate.syx`._
...
| Program slot | 2 |
| Name field | `Snare Plate` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Plates 2.Snare Plate.syx` |
...
| [density](../../bytes/density.md) | 9 | 9 | — | no sheet row |
| [modulation](../../bytes/modulation.md) | 4 | 5 | — | no sheet row |
| [rolloff](../../bytes/rolloff.md) | 9200 Hz | 37 | — | no sheet row |
