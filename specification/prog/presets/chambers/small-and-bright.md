...
_Generated 2026-07-19. Bank: [Chambers](README.md) (index **3**). Source: `sysex/prog/presets/Chambers.Small & Bright.syx`._
...
| Program slot | 6 |
| Name field | `Small & Bright` (matches filename) |
| Name region 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Chambers.Small & Bright.syx` |
...
| [rolloff](../../bytes/rolloff.md) | 12000 Hz | 44 | — | no sheet row |
