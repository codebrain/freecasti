...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 1 s | 16 | — | no sheet row |
...
| [rolloff](../../parameters/rolloff.md) | 12000 Hz | 44 | — | no sheet row |
...
| [lf rt multiply](../../parameters/lf-rt-multiply.md) | 0.75 | 11 | — | no sheet row |
