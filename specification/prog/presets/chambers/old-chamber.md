...
_Generated 2026-07-18. Bank: [Chambers](README.md) (index **3**). Source: `sysex/prog/presets/Chambers.Old Chamber.syx`._
...
| Program slot | 12 |
| Name field | `Old Chamber` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Chambers.Old Chamber.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 2.4 s | 44 | 2.40 | match |
...
| [early to reverb mix](../../parameters/early-to-reverb-mix.md) | 10/20 | 10 | 10/20 | match |
