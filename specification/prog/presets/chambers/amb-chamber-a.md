...
_Generated 2026-07-18. Bank: [Chambers](README.md) (index **3**). Source: `sysex/prog/presets/Chambers.Amb Chamber A.syx`._
...
| Program slot | 14 |
| Name field | `Amb Chamber A` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Chambers.Amb Chamber A.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 1.65 s | 29 | 1.65 | match |
