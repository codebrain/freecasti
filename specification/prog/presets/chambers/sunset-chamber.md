...
_Generated 2026-07-19. Bank: [Chambers](README.md) (index **3**). Source: `sysex/prog/presets/Chambers.Sunset Chamber.syx`._
...
| Program slot | 16 |
| Name field | `Sunset Chamber` (matches filename) |
| Name region 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Chambers.Sunset Chamber.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../bytes/reverb-time.md) | 2.15 s | 39 | — | no sheet row |
