...
_Generated 2026-07-18. Bank: [Chambers](README.md) (index **3**). Source: `sysex/prog/presets/Chambers.CD Chamber.syx`._
...
| Program slot | 11 |
| Name field | `CD Chamber` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Chambers.CD Chamber.syx` |
...
| [size](../../parameters/size.md) | 9 | 9 | 9 | match |
