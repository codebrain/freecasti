...
_Generated 2026-07-19. Bank: [Chambers](README.md) (index **3**). Source: `sysex/prog/presets/Chambers.Stone Chamber.syx`._
...
| Program slot | 18 |
| Name field | `Stone Chamber` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Chambers.Stone Chamber.syx` |
...
| [delay modulation](../../bytes/delay-modulation.md) | 2 | 3 | — | not on sheet |
