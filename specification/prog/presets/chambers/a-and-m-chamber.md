...
_Generated 2026-07-18. Bank: [Chambers](README.md) (index **3**). Source: `sysex/prog/presets/Chambers.A&M Chamber.syx`._
...
| Program slot | 10 |
| Name field | `A&M Chamber` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Chambers.A&M Chamber.syx` |
...
| [vlf cut](../../parameters/vlf-cut.md) | -14 dB | 6 | -14 | match |
| [early to reverb mix](../../parameters/early-to-reverb-mix.md) | 15/20 | 15 | 15/20 | match |
