...
_Generated 2026-07-18. Bank: [Chambers](README.md) (index **3**). Source: `sysex/prog/presets/Chambers.Tiled Chamber.syx`._
...
| Program slot | 19 |
| Name field | `Tiled Chamber` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Chambers.Tiled Chamber.syx` |
...
| [early to reverb mix](../../parameters/early-to-reverb-mix.md) | 20/19 | 21 | — | no sheet row |
...
| [delay time](../../parameters/delay-time.md) | 260 ms | 20 | — | not on sheet |
| [delay modulation](../../parameters/delay-modulation.md) | 1 | 2 | — | not on sheet |
