...
_Generated 2026-07-18. Bank: [Chambers](README.md) (index **3**). Source: `sysex/prog/presets/Chambers.Echo Chamber.syx`._
...
| Program slot | 21 |
| Name field | `Echo Chamber` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Chambers.Echo Chamber.syx` |
...
| [delay level](../../bytes/delay-level.md) | -8 dB | 13 | — | not on sheet |
| [delay time](../../bytes/delay-time.md) | 348 ms | 31 | — | not on sheet |
