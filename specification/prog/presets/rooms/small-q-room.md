...
_Generated 2026-07-18. Bank: [Rooms](README.md) (index **2**). Source: `sysex/prog/presets/Rooms.Small Q Room.syx`._
...
| Bank | Rooms (index 2) |
| Program slot | 21 |
| Name field | `Small Q Room` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Rooms.Small Q Room.syx` |
...
| [lf rt multiply](../../parameters/lf-rt-multiply.md) | 1.1 | 18 | 1.10 | match |
