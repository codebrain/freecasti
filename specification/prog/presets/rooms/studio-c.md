...
_Generated 2026-07-18. Bank: [Rooms](README.md) (index **2**). Source: `sysex/prog/presets/Rooms.Studio C.syx`._
...
| Bank | Rooms (index 2) |
| Program slot | 3 |
| Name field | `Studio C` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Rooms.Studio C.syx` |
...
| [size](../../parameters/size.md) | 2 | 2 | 2 | match |
...
| [early to reverb mix](../../parameters/early-to-reverb-mix.md) | 20/17 | 23 | 20/17 | match |
| [early rolloff](../../parameters/early-rolloff.md) | 8000 Hz | 34 | 8000 | match |
| [early select](../../parameters/early-select.md) | 4 | 4 | 4 | match |
