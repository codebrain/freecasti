...
_Generated 2026-07-18. Bank: [Rooms](README.md) (index **2**). Source: `sysex/prog/presets/Rooms.Studio K.syx`._
...
| Bank | Rooms (index 2) |
| Program slot | 30 |
| Name field | `Studio K` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Rooms.Studio K.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 0.2 s | 0 | — | no sheet row |
...
| [hf rt multiply](../../parameters/hf-rt-multiply.md) | 0.4 | 4 | — | no sheet row |
| [hf rt crossover](../../parameters/hf-rt-crossover.md) | 7200 Hz | 25 | — | no sheet row |
| [lf rt multiply](../../parameters/lf-rt-multiply.md) | 1.4 | 24 | — | no sheet row |
...
| [early rolloff](../../parameters/early-rolloff.md) | 7200 Hz | 32 | — | no sheet row |
