...
_Generated 2026-07-18. Bank: [Rooms](README.md) (index **2**). Source: `sysex/prog/presets/Rooms.Small Tiled.syx`._
...
| Bank | Rooms (index 2) |
| Program slot | 13 |
| Name field | `Small Tiled` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Rooms.Small Tiled.syx` |
...
| [lf rt multiply](../../parameters/lf-rt-multiply.md) | 0.45 | 5 | 0.45 | match |
