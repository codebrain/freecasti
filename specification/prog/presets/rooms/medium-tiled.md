...
_Generated 2026-07-19. Bank: [Rooms](README.md) (index **2**). Source: `sysex/prog/presets/Rooms.Medium Tiled.syx`._
...
| Bank | Rooms (index 2) |
| Program slot | 12 |
| Name field | `Medium Tiled` (matches filename) |
| Name region 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Rooms.Medium Tiled.syx` |
...
| [early rolloff](../../bytes/early-rolloff.md) | 16000 Hz | 54 | — | no sheet row |
