...
_Generated 2026-07-18. Bank: [Rooms](README.md) (index **2**). Source: `sysex/prog/presets/Rooms.Corn Room.syx`._
...
| Bank | Rooms (index 2) |
| Program slot | 32 |
| Name field | `Corn Room` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Rooms.Corn Room.syx` |
...
| [hf rt crossover](../../parameters/hf-rt-crossover.md) | 1200 Hz | 12 | — | no sheet row |
| [lf rt multiply](../../parameters/lf-rt-multiply.md) | 0.4 | 4 | — | no sheet row |
