...
_Generated 2026-07-18. Bank: [Rooms](README.md) (index **2**). Source: `sysex/prog/presets/Rooms.Small Room.syx`._
...
| Dump file | `Rooms.Small Room.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 0.6 s | 8 | 0.60 | match |
| [size](../../parameters/size.md) | small | 0 | Small | match |
...
| [early select](../../parameters/early-select.md) | 6 | 6 | 6 | match |
