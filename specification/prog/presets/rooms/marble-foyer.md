...
_Generated 2026-07-18. Bank: [Rooms](README.md) (index **2**). Source: `sysex/prog/presets/Rooms.Marble Foyer.syx`._
...
| Bank | Rooms (index 2) |
| Program slot | 19 |
| Name field | `Marble Foyer` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Rooms.Marble Foyer.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 1.25 s | 21 | 1.25 | match |
...
| [lf rt multiply](../../parameters/lf-rt-multiply.md) | 0.65 | 9 | 0.65 | match |
...
| [early rolloff](../../parameters/early-rolloff.md) | 16400 Hz | 55 | 16400 | match |
