...
_Generated 2026-07-18. Bank: [Rooms](README.md) (index **2**). Source: `sysex/prog/presets/Rooms.Studio E.syx`._
...
| Bank | Rooms (index 2) |
| Program slot | 5 |
| Name field | `Studio E` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Rooms.Studio E.syx` |
...
| [size](../../parameters/size.md) | 1 | 1 | 1 | match |
...
| [vlf cut](../../parameters/vlf-cut.md) | -1 dB | 19 | -1 | match |
