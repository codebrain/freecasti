...
_Generated 2026-07-18. Bank: [Rooms](README.md) (index **2**). Source: `sysex/prog/presets/Rooms.Center Room.syx`._
...
| Bank | Rooms (index 2) |
| Program slot | 28 |
| Name field | `Center Room` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Rooms.Center Room.syx` |
...
| [predelay](../../parameters/predelay.md) | 2 ms | 1 | 2 | match |
...
| [early select](../../parameters/early-select.md) | 5 | 5 | 5 | match |
