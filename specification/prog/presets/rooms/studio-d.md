...
_Generated 2026-07-18. Bank: [Rooms](README.md) (index **2**). Source: `sysex/prog/presets/Rooms.Studio D.syx`._
...
| Bank | Rooms (index 2) |
| Program slot | 4 |
| Name field | `Studio D` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Rooms.Studio D.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 0.45 s | 5 | 0.45 | match |
...
| [lf rt multiply](../../parameters/lf-rt-multiply.md) | 1.5 | 26 | 1.50 | match |
| [lf rt crossover](../../parameters/lf-rt-crossover.md) | 320 Hz | 6 | 320 | match |
| [vlf cut](../../parameters/vlf-cut.md) | 0 dB | 20 | 0 | match |
| [early to reverb mix](../../parameters/early-to-reverb-mix.md) | 18/20 | 18 | 18/20 | match |
| [early rolloff](../../parameters/early-rolloff.md) | 14800 Hz | 51 | ? | skipped |
