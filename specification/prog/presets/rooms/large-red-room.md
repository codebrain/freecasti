...
_Generated 2026-07-19. Bank: [Rooms](README.md) (index **2**). Source: `sysex/prog/presets/Rooms.Large Red Room.syx`._
...
| Bank | Rooms (index 2) |
| Program slot | 22 |
| Name field | `Large Red Room` (matches filename) |
| Name region 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Rooms.Large Red Room.syx` |
...
| [rolloff](../../bytes/rolloff.md) | 9600 Hz | 38 | — | no sheet row |
