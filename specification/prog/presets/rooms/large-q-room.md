...
_Generated 2026-07-18. Bank: [Rooms](README.md) (index **2**). Source: `sysex/prog/presets/Rooms.Large Q Room.syx`._
...
| Bank | Rooms (index 2) |
| Program slot | 20 |
| Name field | `Large Q Room` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Rooms.Large Q Room.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 2.6 s | 48 | 2.60 | match |
...
| [hf rt crossover](../../parameters/hf-rt-crossover.md) | 1000 Hz | 11 | 1000 | match |
...
| [early rolloff](../../parameters/early-rolloff.md) | 16800 Hz | 56 | 16800 | match |
