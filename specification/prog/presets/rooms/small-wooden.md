...
_Generated 2026-07-18. Bank: [Rooms](README.md) (index **2**). Source: `sysex/prog/presets/Rooms.Small Wooden.syx`._
...
| Bank | Rooms (index 2) |
| Program slot | 10 |
| Name field | `Small Wooden` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Rooms.Small Wooden.syx` |
