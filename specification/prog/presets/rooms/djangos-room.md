...
_Generated 2026-07-18. Bank: [Rooms](README.md) (index **2**). Source: `sysex/prog/presets/Rooms.Djangos Room.syx`._
...
| Bank | Rooms (index 2) |
| Program slot | 15 |
| Name field | `Djangos Room` (matches filename) |
| Name bytes 8-87 | match filename preset (ASCII space-padded) |
| Dump file | `Rooms.Djangos Room.syx` |
...
|-----------|------|--------:|-------|--------|
| [reverb time](../../parameters/reverb-time.md) | 0.8 s | 12 | 0.80 | match |
...
| [modulation](../../parameters/modulation.md) | 3 | 4 | 3 | match |
...
| [lf rt crossover](../../parameters/lf-rt-crossover.md) | 480 Hz | 9 | 500 | match |
...
| [early rolloff](../../parameters/early-rolloff.md) | 12800 Hz | 46 | 12900 | match |
