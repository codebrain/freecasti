...
| 130 | 1 | `00` | known | Engine/bank-class flag: 0 on classic banks (Halls…Spaces), 1 on `* 2` banks (Halls 2…Spaces 2), 2 on NonLin. Most parameter-series dumps show 1 (captured from Large Church, Halls 2); the LF RT multiply/crossover series show 0 (Large Hall) |
